...
{
	var sPanelDisplay = $('#panel').css('display');
	
	// check if the panel is displayed or not
	if(sPanelDisplay == "none")
	{
		panel_Show(true);
	}
	else
...
function panel_Hide(slide)
{
	...
	if(slide)
	{
		$('#panel .panel-content').fadeOut(500, function() {
			$('#panel').slideUp();
		});
	}
	else
